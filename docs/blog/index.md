...
![image.png](https://mindu2.github.io/blog/reasoning공부/deepseekmath_eval.png)

그림은 마지막 두줄 보면 됨
PPO

![image.png](https://mindu2.github.io/blog/reasoning공부/deepseekmath_ppo.png)
...
![image.png](https://mindu2.github.io/blog/reasoning공부/kl_divergency.png)
...
![image.png](https://mindu2.github.io/blog/reasoning공부/deepseekmath_grpo.png)
...
![image.png](https://mindu2.github.io/blog/reasoning공부/ppo_loss.png)

x라는 프롬프트에 대해 yw와 yl을 출력하는 분포에 대해서 보상모델이 내놓은 yw의 점수와 yl점수간의 차이가 커지도록 학습

PPO-ptx 오브젝트 함수(ptx는 모델의 로스를 의미), 참고 PPO는 토큰단위 계산

![image.png](https://mindu2.github.io/blog/reasoning공부/ppo_object.png)
...
![image.png](https://mindu2.github.io/blog/reasoning공부/deepseekr1_outline.png)
